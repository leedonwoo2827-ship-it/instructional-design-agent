...
- 도입·구간 전환·요약 표지 성격: "section".
- 구체적 장면·활동·인물·기기·사례가 연상되는 슬라이드: "photo" + 영어 image_query. bullets 3~4개. **적극 사용(전체의 약 30~50%).**
- 구성요소/단계/절차의 순서 나열: "process" (items[].label 2~5개, 필요시 desc).
- 3~4개의 병렬 개념·분류·유형: "cards" (items[].label + desc).
- 두 개념 대비/비교: "compare" (items 2개, 각 {"label","lines":[...]}).
- 표가 자연스러운 것(구성 개요·평가 유형 등): "table" (headers:[...], rows:[[...]]).
- 순수 추상 이론·정의 나열 등 위에 안 맞는 것: "bullets".
공통: 모든 슬라이드에 chip(요약 한 문장)을 넣는다. 같은 타입이 여러 장 연속되지 않게 사진·도식·불릿을 다양하게 섞어라. process/cards엔 key(하단 핵심 한 줄)를 넣어도 좋다.
"""
